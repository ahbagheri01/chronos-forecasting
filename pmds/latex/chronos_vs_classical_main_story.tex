...
% -----------------------------------------------------------------------------
\begin{frame}{Clear empirical separation: M4 Hourly MASE}
  \vspace{-0.02cm}
  \begin{center}
    \includegraphics[width=0.94\linewidth]{m4-mase-separated-case.png}
  \end{center}

  \vspace{-0.04cm}
  \begin{center}\small
    \tagbox{TealLight}{\textbf{64.1\% lower aggregate MASE}}
    \hspace{0.15cm}
    Chronos Base tracks the cycle; Seasonal Naive is phase-shifted.
  \end{center}
\end{frame}
...
% -----------------------------------------------------------------------------
\begin{frame}{Close empirical contest: USGS Streamflow MASE}
  \vspace{-0.02cm}
  \begin{center}
    \includegraphics[width=0.94\linewidth]{usgs-mase-close-case.png}
  \end{center}

  \vspace{-0.04cm}
  \begin{center}\small
    \tagbox{GoldLight}{\textbf{6.75\% aggregate gap}}
    \hspace{0.15cm}
    Moirai leads Auto-ARIMA, while both forecasts smooth over the observed peak.
  \end{center}
\end{frame}
  ...
  \begin{columns}[T,totalwidth=0.92\linewidth]
    ...
    \begin{column}{0.43\linewidth}
      ...
      \begin{itemize}\setlength{\itemsep}{0.10cm}
        ...
        \item Some foundation model wins are very close, as seen for M1 and
          USGS MASE.
      \end{itemize}
    \end{column}
  \end{columns}
