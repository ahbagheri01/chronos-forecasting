...
\begin{frame}{When every foundation model beats every comparator}
  ...
  \begin{center}
    ...
    \begin{tabular}{L{2.85cm} C{3.20cm} C{3.20cm} C{3.20cm}}
      ...
      Traffic\textsuperscript{\(\dagger\)} & \cellcolor{CoralLight}\textit{not strict} & $\checkmark$ Moirai & $\checkmark$ Moirai \\
      \bottomrule
    \end{tabular}
  \end{center}
...
\begin{frame}{Where a foundation model ranks first in a mixed ordering}
  ...
  \begin{center}
    ...
    \begin{tabular}{L{2.85cm} C{3.20cm} C{3.20cm} C{3.20cm}}
      ...
      \rowcolor{Paper} National Illness\textsuperscript{\(\dagger\)} & \cellcolor{PurpleLight}\textbf{TimesFM} & \cellcolor{PurpleLight}\textbf{TimesFM} & \cellcolor{PurpleLight}\textbf{TimesFM} \\
      Traffic\textsuperscript{\(\dagger\)} & \cellcolor{PurpleLight}\textbf{Moirai} & \cellcolor{TealLight}\textit{strict FM} & \cellcolor{TealLight}\textit{strict FM} \\
      \rowcolor{Paper} BLS Macro\textsuperscript{\(\dagger\)} & \cellcolor{GoldLight}\textit{classical first} & \cellcolor{PurpleLight}\textbf{TimesFM} & \cellcolor{PurpleLight}\textbf{TimesFM} \\
      \bottomrule
    \end{tabular}
  \end{center}
  ...
  \textsuperscript{\(\dagger\)}Descriptive low-power dataset.
\end{frame}
...
% -----------------------------------------------------------------------------
\begin{frame}{How to read the repetition results}
  \vspace{0.01cm}
  \begin{center}
    \small
    \textbf{$p_{\mathrm{Holm}}$ is a corrected p-value.}
    Holm correction accounts for testing several dataset and metric combinations
    at the same time.
  \end{center}
  ...
  \begin{columns}[T,totalwidth=0.94\linewidth]
    \begin{column}{0.29\linewidth}
      \colorbox{GreenLight}{\parbox{0.88\linewidth}{\centering
        \large\bfseries $p_{\mathrm{Holm}}<0.05$\par
        \vspace{0.04cm}
        \fontsize{7.7}{8.8}\selectfont
        The observed lead is large relative to seed variation in the three runs.}}
    \end{column}
    \begin{column}{0.29\linewidth}
      \colorbox{PurpleLight}{\parbox{0.88\linewidth}{\centering
        \large\bfseries SI\par
        \vspace{0.04cm}
        \fontsize{7.7}{8.8}\selectfont
        The same positive gap occurs in every run; a finite p-value is undefined.}}
    \end{column}
    \begin{column}{0.29\linewidth}
      \colorbox{GoldLight}{\parbox{0.88\linewidth}{\centering
        \large\bfseries $p_{\mathrm{Holm}}\geq0.05$\par
        \vspace{0.04cm}
        \fontsize{7.7}{8.8}\selectfont
        Three repetitions do not distinguish the lead from seed variation.}}
    \end{column}
  \end{columns}
  ...
  \begin{center}
    ...
    \setlength{\tabcolsep}{5.5pt}
    \begin{tabular}{L{2.70cm} C{2.40cm} L{6.50cm}}
      \toprule
      \textbf{Example} & \textbf{Reported value} & \textbf{Interpretation} \\
      \midrule
      M4 Hourly CRPS & \cellcolor{GreenLight}\textbf{$p=0.010$} & The lead remains clear after correcting for multiple tests. \\
      \rowcolor{Paper} M1 Yearly WQL & \cellcolor{GoldLight}\textbf{$p=0.068$} & The observed lead is not resolved by three repetitions. \\
      BLS Macro MASE & \cellcolor{PurpleLight}\textbf{SI} & The same positive gap is recorded in every repetition. \\
      \bottomrule
    \end{tabular}
  \end{center}
  ...
  \vspace{0.02cm}
  \begin{center}
    \colorbox{TealLight}{\parbox{0.84\linewidth}{\centering\scriptsize
      These results describe repeatability across the three random seeds.}}
  \end{center}
\end{frame}
...
% -----------------------------------------------------------------------------
\begin{frame}{Conclusion: what the empirical results show}
  \vspace{0.08cm}
  \begin{columns}[T,totalwidth=0.94\linewidth]
    \begin{column}{0.29\linewidth}
      \colorbox{PurpleLight}{\parbox{0.88\linewidth}{\centering
        \fontsize{16}{18}\selectfont\bfseries 33 of 36\par
        \scriptsize foundation model ranks first}}
    \end{column}
    \begin{column}{0.29\linewidth}
      \colorbox{TealLight}{\parbox{0.88\linewidth}{\centering
        \fontsize{16}{18}\selectfont\bfseries 16\par
        \scriptsize strict foundation dominance}}
    \end{column}
    \begin{column}{0.29\linewidth}
      \colorbox{GoldLight}{\parbox{0.88\linewidth}{\centering
        \fontsize{16}{18}\selectfont\bfseries 3\par
        \scriptsize classical model ranks first}}
    \end{column}
  \end{columns}
  ...
  \begin{center}
    \normalsize\bfseries
    Foundation models usually achieve the lowest aggregate loss,
    \color{Teal}but the pattern is not uniform.\color{Ink}
  \end{center}

  \vspace{0.18cm}
  \begin{columns}[T,totalwidth=0.92\linewidth]
    \begin{column}{0.43\linewidth}
      \tagbox{PurpleLight}{\textbf{The general pattern}}
      \vspace{0.10cm}

      \fontsize{8.4}{9.8}\selectfont
      \begin{itemize}\setlength{\itemsep}{0.10cm}
        \item TimesFM records the most empirical wins.
        \item Chronos and Moirai lead on several datasets where the separation
          from classical methods is substantial.
      \end{itemize}
    \end{column}

    \begin{column}{0.43\linewidth}
      \tagbox{GoldLight}{\textbf{The important exceptions}}
      \vspace{0.10cm}

      \fontsize{8.4}{9.8}\selectfont
      \begin{itemize}\setlength{\itemsep}{0.10cm}
        \item ARIMA has the lowest WQL and CRPS on M1 Yearly.
        \item Auto ARIMA has the lowest MASE on BLS Macro.
        \item Some foundation model wins are relatively close, as seen for M1
          MASE and M3 WQL.
      \end{itemize}
    \end{column}
  \end{columns}
...
% -----------------------------------------------------------------------------
\begin{frame}{Conclusion: what the statistical analysis adds}
  \vspace{0.05cm}
  \begin{center}
    \colorbox{GreenLight}{\parbox{0.88\linewidth}{\centering
      \fontsize{14}{16}\selectfont\bfseries 4 comparisons show complete statistical separation\par
      \vspace{0.05cm}
      \scriptsize NN5 MASE, NN5 WQL, NN5 CRPS, and Weather CRPS}}
  \end{center}

  \vspace{0.18cm}
  \begin{columns}[T,totalwidth=0.92\linewidth]
    \begin{column}{0.43\linewidth}
      \tagbox{TealLight}{\textbf{What is well supported}}
      \vspace{0.10cm}

      \fontsize{8.4}{9.8}\selectfont
      \begin{itemize}\setlength{\itemsep}{0.10cm}
        \item NN5 provides the clearest evidence. TimesFM separates from every
          alternative for all three losses.
        \item Moirai also separates from every alternative for Weather CRPS.
        \item These conclusions agree across adjusted SPA tests and the model
          confidence set.
      \end{itemize}
    \end{column}

    \begin{column}{0.43\linewidth}
      \tagbox{GoldLight}{\textbf{What remains uncertain}}
      \vspace{0.10cm}

      \fontsize{8.4}{9.8}\selectfont
      \begin{itemize}\setlength{\itemsep}{0.10cm}
        \item Most empirical winners remain statistically tied with at least
          one alternative.
        \item Several datasets contain too few paired tasks for a strong claim.
        \item A broad win count therefore says more about coverage than about
          certainty.
      \end{itemize}
    \end{column}
  \end{columns}
  ...
  \vspace{0.16cm}
  \begin{center}
    \colorbox{TealLight}{\parbox{0.86\linewidth}{\centering\scriptsize
      \textbf{Overall:} Foundation models are strong defaults when no retraining
      is available. Classical models still matter, and each claimed improvement
      should be checked for the dataset, the loss, and the available evidence.}}
  \end{center}
\end{frame}
